...
import { apiGet, apiPut, apiGetLLMSuggestions, LLMSuggestionContext, LLMSuggestionResponse, getCurrentUser } from '../../api';
...
export default function EditPost() {
  ...
  const [contentBlocks, setContentBlocks] = useState<ContentBlock[]>([
    { id: '1', type: 'text', content: '', metadata: { level: 1 }, affiliateLink: { type: null } }
  ]);
